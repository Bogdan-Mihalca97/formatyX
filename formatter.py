...
def classify_with_claude(paragraphs, model="claude-sonnet-4-20250514"):
...
def parse_bibliography_ieee(entries, model="claude-sonnet-4-20250514"):
...
def generate_reference_sentences(unreferenced_items, model="claude-sonnet-4-20250514"):
...
def build_reference_insertions(paragraphs, section_map, figure_numbers, table_numbers,
                                referenced_figures, referenced_tables, table_captions_map, model="claude-sonnet-4-20250514"):
...
def generate_table_captions(table_infos, model="claude-sonnet-4-20250514"):
...
def translate_to_english(paragraphs_ro, model="claude-sonnet-4-20250514"):
...
def build_formatted_document(doc_path, section_map, paragraphs, template_path, model="claude-sonnet-4-20250514", authors=None, title_en=None):
